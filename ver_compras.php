<?php
    ...
    if (isset($_POST['update'])) {
        ...
        $descricao = "Alterou a tabela Compras, ID $id. ";
        ...
        VALUES ('Alteração', '$nome_log', '$descricao', 'Compras Pendentes', NOW())";
    ...
    <div class="container mt-3 bg-light">
        <div class="py-2 row form-horizontal-center">
            <div class="rounded card-header text-center bg-primary text-white">
                Informações da Compra (<?php echo $statuspedido ?>)
            </div>
            <form class="py-2 form-group shadow rounded" method="POST" action="ver_compras.php" onsubmit="return validarData()">
                ...
                <div class="py-2 row">
                    <div class="col-6">
                        ...
                        <input type="text" class="mt-1 form-control" id="loja" name="loja" maxlength="255" value="<?php echo $loja ?>">
                    </div>
                </div>
                <div class="py-2 row">
                    <div class="col-9">
