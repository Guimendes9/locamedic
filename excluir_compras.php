<?php
    ...
    if(isset($_POST['excluir'])) {
        ...
        $sqllog = "INSERT INTO log_compras (tipo, descricao, area, data_hora) VALUES ('Exclusão', '$nome_log fez uma exclusão na tabela Compras no ID $id', 'Compras Pendentes', NOW())";
