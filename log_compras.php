...
<body class="bg-light">
    <nav class="navbar">
        <div class="container">
            <h4 class="text-white">Log de Compras</h4>
        ...
        <div class="container py-2">
            <form class="justify-content-center col-12">
                ...
                <div class="text-center py-2">
                    <a href="acoes_compras.php" class="btn btn-danger" data-toggle="tooltip" data-placement="top" title="Limpar a Barra de Pesquisa">Limpar</a>
